...
def problem2_4():
    ...
    for ct in range(0,10):
        listrandom.append(random.random()* 5 + 30)
    print(listrandom)
...
def problem2_5():
    ...
    for ct in range (0,10):
        listrandom2.append(random.randint(1,6))
        print(listrandom2[ct])
...
def problem2_6():
    ...
    for ct in range (0,100):
        listrandom3.append(random.randint(1,6) + random.randint(1,6))
        print(listrandom3[ct])
...
def problem2_7():
    ...
    s = s * (s-a) * (s-b) * (s-c)
    s = s**.5
    print("Area of a triangle with sides", a, b, c, "is", s)
