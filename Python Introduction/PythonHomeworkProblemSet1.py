...
"""
EDIT 2/12/2021: The Following is taken from a homework assignment from a
Coursera course entitled "Phython Programming: A Concise Introduction" by 
Wesleyan University. As such, much of the code and comments are not my own.
However, the solutions are solely my own.
...
#%%
def problem1_2(x,y):
    """ Prints the sum and product of two input variables, x & y, on different
    lines. """
    print(x + y)
    print(x * y)
...
def problem1_7():
     ...
     base1float = float(base1) 
     base2 = input("Enter the length of the other base: ")
     base2float = float(base2)
     height = input("Enter the height: ")
     heightfloat = float(height)
     trap_area = .5 * ((base1float + base2float) * heightfloat)
     print("The area of a trapezoid with bases", base1float, "and", 
           base2float, "and height", heightfloat, "is", trap_area)
